...
// ¿Podrías dar con alguna forma de que la expresión `x + 1 === x - 1` arroje `true`? No
...
// Se te ocurre alguna forma de hacer que la expresión `x > x` de como resultado `true`? No
