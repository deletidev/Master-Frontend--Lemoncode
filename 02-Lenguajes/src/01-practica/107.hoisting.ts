...
/* function fu() {
  console.log(a); //undefined, la variable a no tiene valor,
  //"ha creado una variable sin valor porque sabe que luego va a existir a"
...
(function () {
  var a;
  console.log(a); // undefined porque dentro de la función  tengo una var a a la que le voy a dar valor
  // por lo que me crea una var a, vacia, sobrescribiendo mi var a global dentro de la función
  var a = 2;
  b = 4;
  var c = 3;
})();
